@echo off
REM build_wasm.bat
REM Build TinySoundFont for WebAssembly (Windows)

REM Ensure emscripten is installed and active
REM Install from: https://emscripten.org/docs/getting_started/downloads.html
REM Activate with: emsdk_env.bat
